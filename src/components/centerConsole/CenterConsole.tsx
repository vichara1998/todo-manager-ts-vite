...
import { IoMdAddCircle, IoMdCalendar } from 'react-icons/io';

const CenterConsole = () => {
    return (
        <div className="bg-white dark:bg-primary-fg-dark flex items-center absolute left-1/2 -translate-x-1/2 bottom-10 border border-primary-fg rounded-full p-2 z-90">
            <NewTaskInput />
            <button className="group hover:bg-primary-fg size-10 cursor-pointer  flex items-center justify-center transition rounded-full">
                <IoMdCalendar className="text-xl text-gray-500  group-hover:text-primary-bg dark:text-primary-bg transition" />
            </button>
            <button className="group hover:bg-primary-fg size-10 cursor-pointer  flex items-center justify-center transition rounded-full">
